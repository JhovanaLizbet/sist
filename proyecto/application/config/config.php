...
|
*/
$config['base_url'] = 'http://localhost/03mvc/proyecto/'; // 2do PASO se pone la raiz del proyecto
// 2do PASO AUTOMATICAMENTE CON LINEA 28 Y 29 SE DETECTA LA RAIZ DEL PROYECTO y no como la linea 27
...
|
*/
$config['encryption_key'] = 'Decode';//definimos una clave de encriptacion
...
$config['sess_expiration'] = 7200; //TIEMPO DE EXPIRACION DE LA SESION EN SEGUNDOS (2 HORAS)
